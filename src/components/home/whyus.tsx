        ...
        <section id="why-us" className="py-24 mb-8 px-[10%]">
            <div className="container">
                ...
                <div className="mycard bg-white shadow-md p-5 m-2 rounded">
                    ...
                    <img src="/images/icon_complete (1).png" alt="thumb-up-icon" className="mb-3 mx-auto" />
                ...
                <div className="mycard bg-white shadow-md p-5 m-2 rounded">
                    <div className="card-body text-center">
                    <img src="/images/icon_price (1).png" alt="price-icon" className="mb-3 mx-auto" />
                ...
                <div className="mycard bg-white shadow-md p-5 m-2 rounded">
                    <div className="card-body text-center">
                    <img src="/images/icon_24hrs (1).png" alt="time-icon" className="mb-3 mx-auto" />
                ...
                <div className="mycard bg-white shadow-md p-5 m-2 rounded">
                    <div className="card-body text-center">
                    <img src="/images/icon_professional (1).png" alt="profesional-icon" className="mb-3 mx-auto" />
